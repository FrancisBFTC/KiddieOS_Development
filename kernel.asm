...
; ----------------------------------------------------------
; MikeOS Compatible Routines

; String.asm Library Jumps **************
	jmp os_string_copy			; 0057h
	jmp os_string_compare		; 005Ah
	jmp os_string_join 			; 005Dh
	jmp os_string_to_int 		; 0060h
	jmp os_int_to_string 		; 0063h
	jmp os_string_uppercase 	; 0066h
	jmp os_string_lowercase 	; 0069h
	jmp os_string_length		; 006Ch
; ***************************************

; Math.asm Library Jumps ****************
	jmp os_bcd_to_int			; 006Fh
; ***************************************

; Screen.asm Library Jumps **************
	jmp os_print_string			; 0072h
	jmp os_input_string 		; 0075h
	jmp os_print_newline 		; 0078h
	jmp os_print_1hex			; 007Bh
	jmp os_print_2hex			; 007Eh
	jmp os_print_4hex			; 0081h
	jmp os_move_cursor 			; 0084h
	jmp os_get_cursor_pos 		; 0087h
	jmp os_show_cursor			; 008Ah
	jmp os_hide_cursor 			; 008Dh
	jmp os_clear_screen 		; 0090h
	jmp os_dialog_box 			; 0093h
	jmp os_list_dialog 			; 0096h
	jmp os_file_selector 		; 0099h
; ***************************************

; Keyboard.asm Library Jumps **************
	jmp os_wait_for_key			; 009Ch
	jmp os_check_for_key		; 009Fh
; ***************************************

; Disk.asm Library Jumps **************
	jmp os_get_file_list		; 00A2h
	jmp os_file_exists 			; 00A5h
	jmp os_load_file			; 00A8h
	jmp os_write_file 			; 00ABh
	jmp os_rename_file 			; 00AEh
	jmp os_remove_file 			; 00B1h
	jmp os_get_file_size 		; 00B4h
; ***************************************

; Misc.asm Library Jumps ****************
	jmp os_get_api_version		; 00B7h
	jmp os_pause 				; 00BAh
	jmp os_fatal_error 			; 00BDh
; ***************************************

; ports.asm Library Jumps ***************
	jmp os_port_byte_out		; 00C0h
	jmp os_port_byte_in 		; 00C3h
	jmp os_serial_port_enable	; 00C6h
	jmp os_send_via_serial 		; 00C9h
	jmp os_get_via_serial 		; 00CCh
; ***************************************

; math.asm (Insert above)
	jmp os_get_random 			; 00CFh

; ports.asm Library Jumps ***************
	jmp os_speaker_tone 		; 00D2h
	jmp os_speaker_off 			; 00D5h
; ***************************************



%INCLUDE "Sources/Features/string.asm"
%INCLUDE "Sources/Features/math.asm"
%INCLUDE "Sources/Features/screen.asm"
%INCLUDE "Sources/Features/keyboard.asm"
%INCLUDE "Sources/Features/disk.asm"
%INCLUDE "Sources/Features/misc.asm"
%INCLUDE "Sources/Features/ports.asm"
%INCLUDE "Sources/Features/sound.asm"
; ----------------------------------------------------------
