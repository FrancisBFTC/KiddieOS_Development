...
; FEATURES -- Code to pull into the kernel
	...
	%INCLUDE "Sources/MikeOS/features/cli.asm"
 	%INCLUDE "Sources/MikeOS/features/disk.asm"
	%INCLUDE "Sources/MikeOS/features/keyboard.asm"
	%INCLUDE "Sources/MikeOS/features/math.asm"
	%INCLUDE "Sources/MikeOS/features/misc.asm"
	%INCLUDE "Sources/MikeOS/features/ports.asm"
	%INCLUDE "Sources/MikeOS/features/screen.asm"
	%INCLUDE "Sources/MikeOS/features/sound.asm"
	%INCLUDE "Sources/MikeOS/features/string.asm"
	%INCLUDE "Sources/MikeOS/features/basic.asm"
